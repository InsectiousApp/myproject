...
public class Side1 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent openbackview=new Intent("com.example.sachinverma.droomimagecapture.SIDE2");
    ...
    private File getFile()
    {
        ...
        File image_file=new File(folder,"cam_image_side1.jpg");
        return image_file;
    }

    @Override
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
       // String path="sdcard/camera_app/cam_image_side1.jpg";
